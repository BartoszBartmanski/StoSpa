# StoSpa - Stochastic simulation of spatially extended systems [![Build Status](https://travis-ci.org/BartoszBartmanski/StoSpa.svg?branch=master)](https://travis-ci.org/BartoszBartmanski/StoSpa)
